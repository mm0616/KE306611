...
![](media/image-20251017165354195.png)

**4.测试代码**

![](media/image-20251020150324179.png)

**5.代码说明**

1. 在实验中，在库文件的![](media/image-20251020150437597.png)单元内，找到以下元件。

![](media/image-20251017165549103.png)

2. 当检测到按键信号时，信号端为高电平，即item为1。

![](media/image-20251020150522991.png)
...
![](media/image-20251017165652863.png)
