...
实验中，通过读取模块上S端高低电平，判断传感器弹片是否下压；我们在串口监视器上显示测试结果。
...
![](media/image-20251017170725236.png)

**4.测试代码**

![](media/image-20251020154108591.png)

**5.代码说明**

在实验中，需要在库文件的  ![](media/image-20251020153011339.png)单元内，找到以下元件。

![](media/image-20251017170817337.png)
...
![](media/image-20251017170835421.png)