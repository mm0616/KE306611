...
实验中，测试出传感器X Y Z轴的加速度数值；并且，我们在串口监视器上显示测试数据。
...
![](media/image-20251020095015196.png)

**4.测试代码**

![](media/image-20251021113324535.png)

**5.代码说明**

1. 在实验中，在库文件的![](media/image-20251020153011339.png)单元内，找到以下元件。

![](media/image-20251021113521570.png)
...
![](media/image-20251020095226978.png)