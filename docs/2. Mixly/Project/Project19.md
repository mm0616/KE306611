...
![](media/image-20251017173653084.png)

**4.测试代码**

![](media/image-20251020171040841.png)、

**5.代码说明**

1. 在实验中，在库文件的![](media/image-20251020150437597.png)单元内，找到以下元件。

![](media/image-20251017173825897.png)
...
| -------------------------------------- | ------------------------------------------------------------ | ------------------------------------ |
| 当物体开始穿过传感器凹槽时（一瞬间）   | State检测到变为1，lastState为0，两个数据不相等。             | PushCounter设置为<br/>PushCounter加1 |
...
![](media/image-20251017175107764.png)